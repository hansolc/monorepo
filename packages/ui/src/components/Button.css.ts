  ...
  variants: {
    ...
    ty: {
      elevated: [
        sprinkles({
          position: 'relative',
          color: { default: 'primary', hover: 'primary', focus: 'primary', active: 'primary' },
          boxShadow: { default: 'level1', hover: 'level2', focus: 'level1', active: 'level1' },
      ...
      filled: [
        sprinkles({
          position: 'relative',
          color: 'onPrimary',
          boxShadow: { default: 'level0', hover: 'level1', focus: 'level0', active: 'level0' },
          bg: 'primary',
        }),
        {
          selectors: {
